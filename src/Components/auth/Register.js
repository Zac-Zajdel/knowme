...
class Register extends Component {
  ...
  onSubmit = (e) => {
    ...
    // Second parameter will allow us to redirect from within the action.
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              <h1 className="display-4 text-center mb-5">Sign Up For An Account</h1>
              <form noValidate onSubmit={this.onSubmit}>
                ...
                <TextField
                  ...
                  onChange={this.onChange}
                  error={errors.email}
                  info='Use Gravatar to have a profile photo!'
                />
                <TextField
                  type='password'
...
// Ensures clarity about what properties can be passed
Register.propTypes = {
